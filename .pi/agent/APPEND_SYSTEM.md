 * do not read files from folders `.git` or `node_modules`

Use `ketch` for external research — current information (weather, stock market, sport results), web pages, OSS code, library docs.
